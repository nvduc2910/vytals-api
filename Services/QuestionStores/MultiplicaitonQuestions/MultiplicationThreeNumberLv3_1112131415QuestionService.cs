...
{
    public class MultiplicationThreeNumberLv3_1112131415QuestionService : IQuestionStores
    {
        List<object> QuestionAndAwsers = new List<object>();

        public MultiplicationThreeNumberLv3_1112131415QuestionService()
        {
        ...
        public void RandomQuestion()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                var firstNumber = rd.Next(3, 5);
                var secondNumber = rd.Next(3, 5);
                var thirdNumber = rd.Next(3, 5);
