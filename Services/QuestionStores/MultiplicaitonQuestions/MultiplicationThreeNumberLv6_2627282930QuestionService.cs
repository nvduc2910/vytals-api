...
{
    public class MultiplicationThreeNumberLv6_2627282930QuestionService : IQuestionStores
    {
        List<object> QuestionAndAwsers = new List<object>();

        public MultiplicationThreeNumberLv6_2627282930QuestionService()
        {
        ...
        public void RandomQuestion()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                var firstNumber = rd.Next(6, 8);
                var secondNumber = rd.Next(6, 8);
                var thirdNumber = rd.Next(6, 8);
