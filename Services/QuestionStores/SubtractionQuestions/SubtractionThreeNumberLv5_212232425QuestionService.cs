...
{
    public class SubtractionThreeNumberLv5_212232425QuestionService : IQuestionStores
    {
        List<object> QuestionAndAwsers = new List<object>();

        public SubtractionThreeNumberLv5_212232425QuestionService()
        {
