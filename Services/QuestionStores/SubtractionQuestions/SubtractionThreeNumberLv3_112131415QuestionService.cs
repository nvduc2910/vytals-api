...
{
    public class SubtractionThreeNumberLv3_112131415QuestionService : IQuestionStores
    {
        List<object> QuestionAndAwsers = new List<object>();

        public SubtractionThreeNumberLv3_112131415QuestionService()
        {
