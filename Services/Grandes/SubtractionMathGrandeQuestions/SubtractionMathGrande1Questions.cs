...
namespace Vytals.Services.Grandes.SubtractionMathGrandeQuestions
{
    public class SubtractionMathGrande1Questions : IGrandeQuestionStore
    {
        List<object> QuestionAndAwsers = new List<object>();

        public SubtractionMathGrande1Questions()
        {
