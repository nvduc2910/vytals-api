...
namespace Vytals.Services.Grandes.MultiplicaitonMathGrandeQuestions
{
    public class MultiplicationMathGrande1Questions : IGrandeQuestionStore
    {
        List<object> QuestionAndAwsers = new List<object>();

        public MultiplicationMathGrande1Questions()
        {
