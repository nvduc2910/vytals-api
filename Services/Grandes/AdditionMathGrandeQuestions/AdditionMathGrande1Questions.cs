...
namespace Vytals.Services.Grandes.AdditionMathGrandeQuestions
{
    public class AdditionMathGrande1Questions : IGrandeQuestionStore
    {
        List<object> QuestionAndAwsers = new List<object>();

        public AdditionMathGrande1Questions()
        {
